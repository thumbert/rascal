...
// class WindmillGame {
//   /// The indexing for the list of moves is as follows:
...
//   WindmillGame(this.moves);

//   /// Current moves in the game. The first move is always by Player.one, 
//   /// then Player.two, etc.
//   List<int> moves;
...
//   static final _allMoves = List.generate(24, (i) => i).toSet();
// }

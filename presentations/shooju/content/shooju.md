...
.Shooju[Shooju]
# An introduction for the .red[impatient]

### Tony Humbert
###### 2019-12-12

.citation[`https://github.com/thumbert/rascal/presentations/shooju`]

---

## About Shooju
* A very small company, 7 developers around the world
* Big(gest) customer for them
* Not a lot of visibility into the quality of their operations, processes, code

## Technology
* A timeseries database to replace Tsdb
* Hosted on the Amazon cloud with a Cassandra database backend 
* Cassandra is a Facebook technology that was open sourced and 
    extended
* Drivers/connectors to popular programming languages & Excel are 
    available
...
* Storing and accessing timeseries is a very competitive business 
* Very active field.  A lot of new entrants and established players
* Acceptable performance.  For example, 5 years of hourly data for 10 curves 
    takes about 1.7s to download.  Ideally < 100ms. 
    
## Limitations    
* One purpose database   
* Only stores time ordered pairs (timestamp,numeric) for a curve id
* Each timeseries can have metadata 
* Can't store textual data, e.g. no NCPC type curve  
* Can't store binding constraints data, e.g (timestamp,numeric,tag)       

???
We had a need.  They had the technology. 
Performance should be better.  We have 
